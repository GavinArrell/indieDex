...
<div class="fluid_container">
        <div class="camera_wrap camera_azure_skin" id="camera_wrap_1">
            <div data-thumb="img/journeyslideshow.jpg" data-src="img/journeyslideshow.jpg">
                <div class="camera_caption fadeFromBottom">
                    <em>Journey - PS3 exclusive.</em>
                </div>
            </div>
            <div data-thumb="img/dayzslideshow.jpg" data-src="img/dayzslideshow.jpg">
                <div class="camera_caption fadeFromBottom">
                    <em>DAYZ - stadalone in BETA!.</em>
                </div>
            </div>
            ...
            <div data-thumb="img/chivalryslideshow.jpg" data-src="img/chivalryslideshow.jpg">
                <div class="camera_caption fadeFromBottom">
                    <em>Chivalry - recently updated.</em>
                </div>
            </div>
</div>
</div>
